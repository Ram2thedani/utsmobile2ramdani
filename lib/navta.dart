...
import 'package:uts_muhamadramdani/counterta.dart';
import 'package:uts_muhamadramdani/lorebs.dart';
import 'package:uts_muhamadramdani/loreta.dart';
import 'package:uts_muhamadramdani/skillbs.dart';
import 'package:uts_muhamadramdani/skillta.dart';
import 'package:uts_muhamadramdani/synbs.dart';
import 'package:uts_muhamadramdani/synta.dart';
import 'counterbs.dart';
void main() {
  runApp(const Navta());
}

class Navta extends StatelessWidget {
  const Navta({super.key});
...
class _NavbarState extends State<Navbar> {
  ...
  List<Widget> widgetList = const [
    ...
    Skillta(),
    Counterta(),
    Synta(),//Text('Home', style: TextStyle(fontSize: 50)),
