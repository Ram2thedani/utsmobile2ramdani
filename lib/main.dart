...
import 'package:uts_muhamadramdani/navbs.dart';
import 'package:uts_muhamadramdani/lorebs.dart';
import 'package:uts_muhamadramdani/navta.dart';
...
children: [
  ...
  child: Column(children: [
    ...
    const Padding(
              ...
              child: Image(image: (AssetImage('assets/Bloodseeker_icon.webp'))),),
    const Text('Bloodseeker', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white,),)
...
InkWell(
  onTap: () => Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => Navta()),
  ),
  ...
  child: Column(children: [
    ...
    const Padding(
              padding: EdgeInsets.all(30),
              child: Image(image: (AssetImage('assets/Templar_Assassin_icon.webp'))),),
    const Text('Templar Assassin', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white,),)
